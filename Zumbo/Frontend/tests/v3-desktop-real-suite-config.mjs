...
const matrixTestFile = 'v3-desktop-acceptance-real-browser.mjs';
...
export function realBrowserTestTimeoutMs(testFile, environment = process.env) {
  ...
  return boundedTimeout(
    'ZUMBO_QA_MATRIX_TEST_TIMEOUT_MS',
    environment.ZUMBO_QA_MATRIX_TEST_TIMEOUT_MS,
    matrixTimeoutMs
  );
}
