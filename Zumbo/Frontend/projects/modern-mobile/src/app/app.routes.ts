...
export const routes: Routes = [
  ...
  { path: 'intake/:publicId', loadComponent: () => import('./features/intake/mobile-public-intake.page').then(module => module.MobilePublicIntakePage) },
  {
    ...
    children: [
      ...
      { path: 'integrations', loadComponent: () => import('./features/integrations/mobile-integrations.page').then(module => module.MobileIntegrationsPage) },
      { path: 'operations', loadComponent: () => import('./features/operations/mobile-operations.page').then(module => module.MobileOperationsPage) },
      ...
      { path: 'projects/:projectId/automation', loadComponent: () => import('./features/automation/mobile-automation.page').then(module => module.MobileAutomationPage) },
      { path: 'projects/:projectId/jobs', loadComponent: () => import('./features/jobs/mobile-jobs.page').then(module => module.MobileJobsPage) },
      { path: 'projects/:projectId/insights', loadComponent: () => import('./features/reporting/mobile-reporting.page').then(module => module.MobileReportingPage) },
  ...
  { path: 'projects/:projectId/jobs', loadComponent: () => import('./features/jobs/mobile-jobs.page').then(module => module.MobileJobsPage) },
  { path: 'projects/:projectId/insights', loadComponent: () => import('./features/reporting/mobile-reporting.page').then(module => module.MobileReportingPage) },
  { path: 'profile/integrations', loadComponent: () => import('./features/integrations/mobile-integrations.page').then(module => module.MobileIntegrationsPage) },
  { path: 'profile/operations', loadComponent: () => import('./features/operations/mobile-operations.page').then(module => module.MobileOperationsPage) },
