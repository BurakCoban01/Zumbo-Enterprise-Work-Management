...
internal static partial class ApiHostRegistration
{
    ...
    { ConfigureHostFoundation(builder); ConfigureRateLimiting(builder); ConfigureAuthentication(builder); ConfigureDataProtectionAndRealtime(builder); ConfigureCoreServicesAndStorage(builder); var (provider, isWorkerRole) = ConfigureRuntimeProviders(builder); ConfigureBackgroundJobsAndHealth(builder, provider, isWorkerRole); return builder; }
}
