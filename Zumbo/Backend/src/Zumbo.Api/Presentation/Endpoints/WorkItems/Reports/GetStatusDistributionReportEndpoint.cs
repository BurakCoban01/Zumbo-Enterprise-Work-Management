...
internal static class GetStatusDistributionReportEndpoint
{
    internal static void Map(RouteGroupBuilder group)
    {
        group.MapGet("/reports/status-distribution/{projectId}", async (string projectId, StatusDistributionHandler handler, HttpContext http, CancellationToken ct) =>
