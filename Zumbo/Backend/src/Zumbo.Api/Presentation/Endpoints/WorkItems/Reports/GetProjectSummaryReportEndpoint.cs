...
internal static class GetProjectSummaryReportEndpoint
{
    internal static void Map(RouteGroupBuilder group)
    {
        group.MapGet("/reports/project-summary/{projectId}", async (string projectId, ProjectSummaryHandler handler, HttpContext http, CancellationToken ct) =>
