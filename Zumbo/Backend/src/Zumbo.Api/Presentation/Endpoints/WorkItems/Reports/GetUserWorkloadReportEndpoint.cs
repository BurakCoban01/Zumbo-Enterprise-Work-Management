...
internal static class GetUserWorkloadReportEndpoint
{
    internal static void Map(RouteGroupBuilder group)
    {
        group.MapGet("/reports/user-workload/{projectId}", async (string projectId, UserWorkloadHandler handler, HttpContext http, CancellationToken ct) =>
