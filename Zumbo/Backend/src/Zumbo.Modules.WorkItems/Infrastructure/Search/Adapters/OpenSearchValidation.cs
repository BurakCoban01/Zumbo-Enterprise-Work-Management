...
internal static class OpenSearchValidation
{
    internal static void ValidateConfiguration(OpenSearchOptions options)
    {
    ...
    internal static void ValidateScope(string organizationId, string projectId)
    {
