...
namespace Zumbo.Modules.Identity.Application.Features.TokenRefresh;
...
{
    public async Task<AuthResponse> HandleAsync(RefreshTokenRequest request, CancellationToken ct)
    {
