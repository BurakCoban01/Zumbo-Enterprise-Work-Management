...
public sealed class MongoWorkItemBulkJobRepositoryContractTests : WorkItemBulkJobRepositoryContract, IAsyncLifetime
{
    private readonly MongoDbService mongo;
    private readonly string databaseName;

    public MongoWorkItemBulkJobRepositoryContractTests()
    {
        ...
        databaseName = "ZumboDomain010Contracts_" + Guid.NewGuid().ToString("N");
    ...
    protected override ApplicationPersistence.IDocumentRepository<WorkItemBulkJobDocument> Jobs() => new MongoRepository<WorkItemBulkJobDocument>(mongo);
    protected override ApplicationPersistence.IDocumentRepository<WorkItemBulkJobItemDocument> Items() => new MongoRepository<WorkItemBulkJobItemDocument>(mongo);
}
