...
public sealed class MongoIntakeRepositoryContractTests : IntakeRepositoryContract, IAsyncLifetime
{
    private readonly MongoDbService mongo;
    private readonly string databaseName;

    public MongoIntakeRepositoryContractTests()
    {
        ...
        databaseName = "ZumboFeature001Contracts_" + Guid.NewGuid().ToString("N");
