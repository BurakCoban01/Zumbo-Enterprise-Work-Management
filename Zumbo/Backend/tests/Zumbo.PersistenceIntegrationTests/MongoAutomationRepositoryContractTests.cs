...
public sealed class MongoAutomationRepositoryContractTests : AutomationRepositoryContract, IAsyncLifetime
{
    private readonly MongoDbService mongo;
    private readonly string databaseName;

    public MongoAutomationRepositoryContractTests()
    {
        ...
        databaseName = "ZumboFeature002Contracts_" + Guid.NewGuid().ToString("N");
    ...
    protected override ApplicationPersistence.IDocumentRepository<AutomationRuleDocument> Rules() =>
        new MongoRepository<AutomationRuleDocument>(mongo);
}
