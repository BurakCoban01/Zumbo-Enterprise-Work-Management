    ...
    private static readonly IReadOnlyDictionary<string, string> AcceptedBodyDifferences =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Zumbo.Api|WorkItemEndpoints|method:AddWorkItemsModule:(thisIServiceCollectionservices,IConfiguration?configuration=null):IServiceCollection"] =
                "Work-item create, search, development connection-create/list/read/disconnect/delete, connection-mapping create/list/delete and work-item discovery, work-item-link listing/creation/deletion, webhook reception/processing, credential-rotation, webhook-secret-rotation, provider-health, and repository-discovery handlers remain scoped while the durable webhook adapter resolves the processing handler directly and compatibility services remain registered.",
